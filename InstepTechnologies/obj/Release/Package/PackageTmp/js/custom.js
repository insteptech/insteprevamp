...
jQuery(document).ready(function ($) {
    ...
    (function () {
        ...
        if ($map.length) {
            ...
            $map.gMap({
                address: 'DSS 166, Sector 25, Panchkula, Haryana India',
                zoom: 2,
                markers: [
					{
					    'address': 'DSS 166, Sector 25, Panchkula, Haryana India',
					    'html': "<div><img src='../img/maps/india.png'/><br>DSS 166, Sector 25<br/> Panchkula, Haryana<br/> India</div>",
					    'popup': 'true'
					},
                    {
                        'address': '25 Osprey Road, Birmingham,B23 5JQ ',
                        'html': "<div><img src='../img/maps/uk.png'/><br> 25 Osprey Road<br/> Birmingham<br/> B23 5JQ</div>",
                        'popup': 'true'
                    }
                ]
            }
